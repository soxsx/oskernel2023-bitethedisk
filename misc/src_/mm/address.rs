...
const PA_WIDTH_SV39: usize = 56; // Physical address width
const VA_WIDTH_SV39: usize = 39; // Virtual address width
const PPN_WIDTH_SV39: usize = PA_WIDTH_SV39 - PAGE_SIZE_BITS; // Physical page number width
const VPN_WIDTH_SV39: usize = VA_WIDTH_SV39 - PAGE_SIZE_BITS; // Virtual page number width

give_attr! {
    pub struct PhysAddr(pub usize); // 物理地址 56bit
    pub struct VirtAddr(pub usize); // 物理页号 44bit
    pub struct PhysPageNum(pub usize); // 虚拟地址 39bit
    pub struct VirtPageNum(pub usize); // 虚拟页号 27bit
}
...
impl PhysPageNum {
    ...
    pub fn as_pte_array(&self) -> &mut [PageTableEntry] {
