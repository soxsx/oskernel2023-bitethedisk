...
// use super::vfs::{FSid, VFS};
// use crate::utils::{mem_buffer::MemBuffer, Error, Path};
...
//         unimplemented!();
//     }
//     fn as_dir<'a>(self: Arc<Self>) -> Result<Arc<dyn DirFile + 'a>, Error>
//     where
//         Self: 'a,
//     {
//         Err(Error::EPERM)
//     }
//     fn as_link<'a>(self: Arc<Self>) -> Result<Arc<dyn LinkFile + 'a>, Error>
//     where
//         Self: 'a,
//     {
//         Err(Error::EPERM)
//     }
//     fn as_device<'a>(self: Arc<Self>) -> Result<Arc<dyn DeviceFile + 'a>, Error>
//     where
//         Self: 'a,
//     {
//         Err(Error::EPERM)
//     }
//     fn as_block<'a>(self: Arc<Self>) -> Result<Arc<dyn BlockFile + 'a>, Error>
//     where
//         Self: 'a,
//     {
//         Err(Error::EPERM)
//     }
//     fn as_char<'a>(self: Arc<Self>) -> Result<Arc<dyn CharFile + 'a>, Error>
//     where
//         Self: 'a,
//     {
//         Err(Error::EPERM)
//     }
//     fn as_fifo<'a>(self: Arc<Self>) -> Result<Arc<dyn FIFOFile + 'a>, Error>
//     where
//         Self: 'a,
//     {
//         Err(Error::EPERM)
//     }
//     fn as_file<'a>(self: Arc<Self>) -> Arc<dyn File + 'a>
//     where
//         Self: 'a,
//     {
//         unimplemented!();
//     }
//     fn as_any<'a>(self: Arc<Self>) -> Arc<dyn Any + Send + Sync + 'a>
//     where
//         Self: 'a,
//     {
//         unimplemented!();
